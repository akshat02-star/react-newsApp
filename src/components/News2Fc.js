...
const News2Fc = (props) => {
  let defaultUrl =
    "https://www.shutterstock.com/image-vector/background-screen-saver-on-breaking-600w-723749530.jpg";
  ...
  const fetchData = async () => {
    const url = `https://newsapi.org/v2/top-headlines?country=${
      props.country
    }&category=${props.category}&apiKey=e0f0941740664e618c9e45dc7f76c9e2&page=${
      page + 1
  ...
  return (
    <div className="container my-3">
      <h1 style={{ alignItems: "center", marginTop: "60px" }}>
        Here are the top headlines for today - {capitalize(props.category)}
      </h1>
      {/* { loading && <Spinner />} */}
      <InfiniteScroll
            ...
            return (
              <div className="col-md-3 my-2" key={element.url}>
                <NewsItem
                  ...
                  imageUrl={
                    !element.urlToImage ? defaultUrl : element.urlToImage
                  }
