...
export class News2 extends Component {
  ...
  async update() {
    ...
    this.setState({
      ...
      displayedResults:
        this.state.displayedResults + parsedData.articles.length,
    });
  }
  ...
  fetchData = async () => {
    const url = `https://newsapi.org/v2/top-headlines?country=${
      ...
      this.props.category
    }&apiKey=e0f0941740664e618c9e45dc7f76c9e2&page=${
      this.state.page + 1
              ...
              return (
                <div className="col-md-3 my-2" key={element.url}>
                  <NewsItem
                    ...
                    imageUrl={
                      !element.urlToImage ? this.defaultUrl : element.urlToImage
                    }
